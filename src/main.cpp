...
int main() {
    ...
    Search *mtdf = new MTDF(maxDepth,board2,evaluate2, false, false);
    mtdf->GetBestMove();
    //cout<<"###################"<<endl;
    Board* board3 = new Board();
    board3->fenInterpreter();
    Evaluate* evaluate3 = new Evaluate(board3);
    Search *pvs = new PVS(maxDepth,board3,evaluate3, false);
    pvs->GetBestMove();
