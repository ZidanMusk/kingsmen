...
public:
    ...
    // Zobrist tables
    unsigned long long pawn[2][64] = {{0x79ad695501e7d1e8L, 0x8249a47aee0e41f7L, 0x637a7780decfc0d9L, 0x19fc8a768cf4b6d4L, 0x7bcbc38da25a7f3cL, 0x5093417aa8a7ed5eL, 0x7fb9f855a997142L,  0x5355f900c2a82dc7L,
    ...
    unsigned long long rook[2][64] = {{0xd18d8549d140caeaL, 0x1cfc8bed0d681639L, 0xca1e3785a9e724e5L, 0xb67c1fa481680af8L, 0xdfea21ea9e7557e3L, 0xd6b6d0ecc617c699L, 0xfa7e393983325753L, 0xa09e8c8c35ab96deL,
    ...
    unsigned long long knight[2][64] = {{0x3bba57b68871b59dL, 0xdf1d9f9d784ba010L, 0x94061b871e04df75L, 0x9315e5eb3a129aceL, 0x8bd35cc38336615L,  0xfe9a44e9362f05faL, 0x78e37644e7cad29eL, 0xc547f57e42a7444eL,
    ...
    unsigned long long bishop[2][64] = {{0x2fe4b17170e59750L, 0xe8d9ecbe2cf3d73fL, 0xb57d2e985e1419c7L, 0x572b974f03ce0bbL, 0xa8d7e4dab780a08dL, 0x4715ed43e8a45c0aL, 0xc330de426430f69dL, 0x23b70edb1955c4bfL,
    ...
    unsigned long long queen[2][64] = {{0x720bf5f26f4d2eaaL, 0x1c2559e30f0946beL, 0xe328e230e3e2b3fbL, 0x87e79e5a57d1d13L,  0x8dd9bdfd96b9f63L,  0x64d0e29eea8838b3L, 0xddf957bc36d8b9caL, 0x6ffe73e81b637fb3L,
    ...
    unsigned long long king[2][64] = {{0x2102ae466ebb1148L, 0xe87fbb46217a360eL, 0x310cb380db6f7503L, 0xb5fdfc5d3132c498L, 0xdaf8e9829fe96b5fL, 0xcac09afbddd2cdb4L, 0xb862225b055b6960L, 0x55b6344cf97aafaeL,
    ...
    unsigned long long whiteKingSideCastling = 0x31d71dce64b2c310L;
    unsigned long long whiteQueenSideCastling = 0xf165b587df898190L;
    unsigned long long blackKingSideCastling = 0xa57e6339dd2cf3a0L;
    unsigned long long blackQueenSideCastling = 0x1ef6e6dbb1961ec9L;
    unsigned long long passantColumn[8] = {0x70cc73d90bc26e24L, 0xe21a6b35df0c3ad7L, 0x3a93d8b2806962L,
    ...
    unsigned long long squareZKey(int location, char piece) {
        switch (piece) {
            case 'p':
    ...
    bool locExist(unsigned long long mask, unsigned long long check) {
        return (mask & check) != 0;
    }

    void unsetBit(unsigned long long &mask, unsigned long long bit) {
        mask &= (~(bit));
    }
        ...
        switch (type) {
            case 0:
                if (specialEvent == PROMOTEBISHOP || specialEvent == PROMOTEKNIGHT || specialEvent == PROMOTEQUEEN ||
                    ...
                    whitePawns ^= moveXor, key ^= squareZKey(to, 'p') ^ squareZKey(from, 'p');
            ...
            case 1:
                ...
                key ^= squareZKey(from, 'n') ^ squareZKey(to, 'n');
                break;
            case 2:
                whiteBishops ^= moveXor;
                key ^= squareZKey(from, 'b') ^ squareZKey(to, 'b');
                break;
            case 3:
                whiteRooks ^= moveXor;
                key ^= squareZKey(from, 'r') ^ squareZKey(to, 'r');
                break;
            case 4:
                whiteQueens ^= moveXor;
                key ^= squareZKey(from, 'q') ^ squareZKey(to, 'q');
                break;
            case 5:
                whiteKing ^= moveXor;
