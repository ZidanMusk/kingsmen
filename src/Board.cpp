...
//==================================================Bishop valid Moves
    ...
    int kingSafty() {
        ...
        phase -=
                (__builtin_popcountll(whiteKnights) + __builtin_popcountll(blackKnights)) * piecePhase[knightTypeNum()];
        phase -=
                (__builtin_popcountll(whiteBishops) + __builtin_popcountll(blackBishops)) * piecePhase[bishopTypeNum()];
